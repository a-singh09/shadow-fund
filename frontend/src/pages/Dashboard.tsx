              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    if (action.route) {
                      return (
                        <Link key={index} to={action.route} className="glass p-6 rounded-xl border border-red-500/20 hover-lift cursor-pointer transition-all duration-300">
                          <div className={`w-12 h-12 rounded-xl mb-4 flex items-center justify-center ${
                            action.color === 'red' ? 'bg-red-500/10 border border-red-500/20' :
                            action.color === 'blue' ? 'bg-blue-500/10 border border-blue-500/20' :
                            action.color === 'green' ? 'bg-green-500/10 border border-green-500/20' :
                      ...
                      return (
                        <div key={index} className="glass p-6 rounded-xl border border-red-500/20 hover-lift cursor-pointer transition-all duration-300">
                          <div className={`w-12 h-12 rounded-xl mb-4 flex items-center justify-center ${
                            action.color === 'red' ? 'bg-red-500/10 border border-red-500/20' :
                            action.color === 'blue' ? 'bg-blue-500/10 border border-blue-500/20' :
                            action.color === 'green' ? 'bg-green-500/10 border border-green-500/20' :
              ...
              <div className="space-y-6">
                ...
                <div className="glass p-6 rounded-xl border border-red-500/20">
                  <div className="text-center">
                    ...
                    <h3 className="font-semibold text-white mb-1">Creator Profile</h3>
                    <p className="text-sm text-gray-400 mb-4">wallet address: 0x1234...5678</p>
